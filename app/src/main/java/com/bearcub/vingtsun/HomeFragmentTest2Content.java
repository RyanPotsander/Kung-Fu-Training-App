 ...
 */
public class HomeFragmentTest2Content extends android.support.v4.app.Fragment {
    private static final String KEY_TITLE = "title";
    private static final String KEY_INDICATOR_COLOR = "indicator_color";
    private static final String KEY_DIVIDER_COLOR = "divider_color";

    public static HomeFragmentTest2Content newInstance(CharSequence title, int indicatorColor,
                                                       int dividerColor){
        ...
        HomeFragmentTest2Content fragment = new HomeFragmentTest2Content();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.pager_item_home_test_2, container, false);
    }
